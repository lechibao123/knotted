...
$(function () {
  ...
  window.addEventListener('scroll', function () {
    if (window.pageYOffset > 100) sticky.classList.add('sticky');else sticky.classList.remove('sticky');
  });
});
...
var loadMore = function loadMore(item, show) {
  ...
  $('.more').click(function () {
    ...
    if (shown < items) $('.gallery-items li:lt(' + shown + ')').show(300);else {
...
var loadMoreNews = function loadMoreNews(item) {
  ...
  $('.more').click(function () {
    ...
    if (shown < items) $('.gallery-item li:lt(' + shown + ')').show(300);else {
